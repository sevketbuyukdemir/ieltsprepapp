...
class WritingFragment(private var sectionNo: Int,
    ...
    private fun init(view : View){
        // Bind views with Ids
        listView = view.findViewById(R.id.writing_tv_list_view)
    ...
    private class ListViewAdapter(private var sectionNo : Int,
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            val rowView = inflater.inflate(R.layout.writing_text_item, parent, false)

            val textView = rowView.findViewById(R.id.tv_writing_text_item) as TextView
            if(position == 0) {
            ...
            if((sectionNo == 1) && (position == (dataSource.size - 1))){
                ...
                textView.textSize = 20F
                textView.textAlignment = TextView.TEXT_ALIGNMENT_CENTER
                val imageView = rowView.findViewById(R.id.iv_writing_text_item) as ImageView
                imageView.setImageResource(R.drawable.writing_task_one_image)
            }
            return rowView
        }
    }
